...
namespace TaskInsider.Controllers
{
    public class SkillLevelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SkillLevelID,SkillLevelName")] SkillLevel skillLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SkillLevelID,SkillLevelName")] SkillLevel skillLevel)
        {
            if (ModelState.IsValid)
            {
