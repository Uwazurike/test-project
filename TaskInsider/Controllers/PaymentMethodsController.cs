...
namespace TaskInsider.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentMethodID,PaymentMethod1")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentMethodID,PaymentMethod1")] PaymentMethod paymentMethod)
        {
            if (ModelState.IsValid)
            {
